...
F:G$le_tecla$0$0({2}DF,SC:U),C,0,0,0,0,0
...
F:G$Timer4_ISR$0$0({2}DF,SV:S),C,0,0,1,16,0
...
S:Lmain.esc_glcd$byte$1$28({1}SC:U),R,0,0,[r7]
S:Lmain.init_GLCD$cs$1$30({1}SC:U),R,0,0,[r7]
S:Lmain.conf_Y$y$1$32({1}SC:U),R,0,0,[r7]
S:Lmain.conf_pag$pag$1$34({1}SC:U),R,0,0,[r7]
S:Lmain.limpa_glcd$x$1$37({1}SC:U),R,0,0,[r7]
S:Lmain.limpa_glcd$y$1$37({1}SC:U),R,0,0,[r6]
S:Lmain.escreve_caractere$c$1$44({1}SC:U),R,0,0,[r7]
S:Lmain.escreve_caractere$linha$1$45({1}SC:U),R,0,0,[r7]
S:Lmain.putchar$c$1$46({1}SC:U),R,0,0,[r7]
S:G$end_fim_ram$0$0({2}SI:U),E,0,0
S:Lmain.verifica_RAM_SPI$i$1$66({2}SI:U),R,0,0,[r6,r7]
S:Lmain.verifica_RAM_SPI$aux$1$66({1}SC:U),R,0,0,[r3]
S:G$TECLA$0$0({1}SC:U),E,0,0
S:G$TECLA_ANT$0$0({1}SC:U),E,0,0
S:G$tecla$0$0({1}SC:U),E,0,0
S:Lmain.ligar_buzzer$ciclos$1$74({2}SI:U),R,0,0,[r6,r7]
S:Lmain.ligar_buzzer$meio_periodo$1$74({2}SI:U),R,0,0,[]
S:Lmain.contagemRegressiva$tempoTotal$1$81({2}SI:S),R,0,0,[r6,r7]
S:Lmain.contagemRegressiva$minutos$1$82({2}SI:S),R,0,0,[r4,r5]
S:Lmain.contagemRegressiva$segundos$1$82({2}SI:S),R,0,0,[r2,r3]
S:Lmain.contagemRegressiva$tempoRestante$1$82({2}SI:S),R,0,0,[r6,r7]
S:Lmain.resetar_tempo$tecla$1$84({2}SI:S),R,0,0,[r6,r7]
S:Lmain.definir_tempo_botao$tempoReal$1$87({2}SI:S),R,0,0,[]
S:Lmain.definir_tempo_botao$m1$1$87({2}SI:S),R,0,0,[r6,r7]
S:Lmain.definir_tempo_botao$m2$1$87({2}SI:S),R,0,0,[r4,r5]
S:Lmain.definir_tempo_botao$s1$1$87({2}SI:S),R,0,0,[r2,r3]
S:Lmain.definir_tempo_botao$s2$1$87({2}SI:S),R,0,0,[r0,r1]
S:Lmain.definir_tempo_bluetooth$tempoReal$1$88({2}SI:S),R,0,0,[r6,r7]
S:Lmain.escolher_entrada$tecla_menu$1$89({2}SI:S),R,0,0,[r6,r7]
S:Lmain.escolher_entrada$tempo_digital$1$89({2}SI:S),R,0,0,[r4,r6]
S:Lmain.ISR_TC2$tecla_atu$1$97({1}SC:U),R,0,0,[r7]
S:Lmain.main$aux$1$104({2}SI:S),R,0,0,[r6,r7]
S:G$terminal_ativo$0$0({1}SB0$1:U),H,0,0
S:Lmain.le_glcd$cd$1$26({1}SB0$1:U),H,0,0
S:Lmain.le_glcd$cs$1$26({1}SB0$1:U),H,0,0
S:Lmain.esc_glcd$cd$1$28({1}SB0$1:U),H,0,0
S:Lmain.esc_glcd$cs$1$28({1}SB0$1:U),H,0,0
S:Lmain.init_GLCD$sloc0$1$0({1}SB0$1:U),H,0,0
S:Lmain.conf_Y$cs$1$32({1}SB0$1:U),H,0,0
S:Lmain.conf_pag$cs$1$34({1}SB0$1:U),H,0,0
S:Lmain.limpa_glcd$cs$1$36({1}SB0$1:U),H,0,0
S:Lmain.escreve_caractere$cs$1$44({1}SB0$1:U),H,0,0
S:Lmain.putchar$lado$1$47({1}SB0$1:U),H,0,0
...
S:G$le_tecla$0$0({2}DF,SC:U),C,0,0
...
S:G$Timer4_ISR$0$0({2}DF,SV:S),C,0,0
